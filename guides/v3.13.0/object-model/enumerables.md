...
[`MutableArray`](https://api.emberjs.com/ember/3.13/classes/MutableArray) API. The most common
  ...
  <div class="cta-note">
    <div class="cta-note-body">
      ...
      <div class="cta-note-message">
        ...
        <a href="https://guides.emberjs.com/v3.13.0/configuring-ember/disabling-prototype-extensions/">
...
reference documentation`](https://api.emberjs.com/ember/3.13/classes/MutableArray).

### Iterating Over an Enumerable

To enumerate all the values of an enumerable object, use the [`forEach()`](https://api.emberjs.com/ember/3.13/classes/MutableArray/methods/forEach?anchor=forEach)
method:
...
All enumerables expose [`firstObject`](https://api.emberjs.com/ember/3.13/classes/MutableArray/properties/firstObject?anchor=firstObject) and [`lastObject`](https://api.emberjs.com/ember/3.13/classes/MutableArray/properties/lastObject?anchor=lastObject) properties
...
[`map()`](https://api.emberjs.com/ember/3.13/classes/MutableArray/methods/map?anchor=map) method, which creates a new array with results of calling a
...
If your enumerable is composed of objects, there is a [`mapBy()`](https://api.emberjs.com/ember/3.13/classes/MutableArray/methods/mapBy?anchor=mapBy)
...
For arbitrary filtering, use the [`filter()`](https://api.emberjs.com/ember/3.13/classes/MutableArray/methods/filter?anchor=filter) method.  The filter method
...
When working with a collection of Ember objects, you will often want to filter a set of objects based upon the value of some property. The [`filterBy()`](https://api.emberjs.com/ember/3.13/classes/MutableArray/methods/filterBy?anchor=filterBy) method provides a shortcut.
...
containing all of the matched values, you can use [`find()`](https://api.emberjs.com/ember/3.13/classes/MutableArray/methods/find?anchor=find) and [`findBy()`](https://api.emberjs.com/ember/3.13/classes/MutableArray/methods/findBy?anchor=findBy),
...
use the [`every()`](https://api.emberjs.com/ember/3.13/classes/MutableArray/methods/every?anchor=every) method:
...
you can use the [`any()`](https://api.emberjs.com/ember/3.13/classes/MutableArray/methods/any?anchor=any) method:
